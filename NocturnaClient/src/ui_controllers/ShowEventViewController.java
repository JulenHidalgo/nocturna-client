...
/**
 * Controlador de la vista para mostrar detalles de un evento. si el usuario es
 * cliente permite seleccionar cuantas entradas quiere comprar
 *
 * @author Erlantz
 */
public class ShowEventViewController {
    ...
    /**
     * Etiqueta para mostrar el tipo de música de los artistas que actuan en el
     * evento.
     */
    @FXML
    Label lblTipoMusica;
    ...
    /**
     * Resta el numero de entradas que quiere comprar siendo 1 el minimo
     * permitido muestra alert si intenta bajar del 1
     *
     * @param event
     */
    @FXML
    ...
    /**
     * Suma el numero de entradas que quiere comprar Muestra una alerta si el
     * número de entradas qu equiere intenta superar el numero de entradas que
     * quedan en el evento(NumEntradas).
     *
     * @param event
     */
    @FXML
    ...
    /**
     * Navega a la vista de compra de entradas. Inicializa el controlador de la
     * vista de compra de entradas con el evento actual y la cantidad de
     * entradas que quiere comprar.
     *
     * @param aevent
     */
    @FXML
    ...
    /**
     * Inicializa la escena de la ventana. Configura la ventana, el tema y los
